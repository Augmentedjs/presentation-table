(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("augmentedjs-next"), require("presentation-decorator"), require("presentation-dom"), require("presentation-models"), require("presentation-request"));
	else if(typeof define === 'function' && define.amd)
		define("presentation-table", ["augmentedjs-next", "presentation-decorator", "presentation-dom", "presentation-models", "presentation-request"], factory);
	else if(typeof exports === 'object')
		exports["presentation-table"] = factory(require("augmentedjs-next"), require("presentation-decorator"), require("presentation-dom"), require("presentation-models"), require("presentation-request"));
	else
		root["presentation-table"] = factory(root["Augmented"], root["presentation-decorator"], root["presentation-dom"], root["presentation-models"], root["presentation-request"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_augmentedjs_next__, __WEBPACK_EXTERNAL_MODULE_presentation_decorator__, __WEBPACK_EXTERNAL_MODULE_presentation_dom__, __WEBPACK_EXTERNAL_MODULE_presentation_models__, __WEBPACK_EXTERNAL_MODULE_presentation_request__) {
...
var _augmentedjsNext = __webpack_require__(/*! augmentedjs-next */ "augmentedjs-next");
...
/***/ "augmentedjs-next":
/*!***************************************************************************************************************************!*\
  !*** external {"commonjs":"augmentedjs-next","commonjs2":"augmentedjs-next","amd":"augmentedjs-next","root":"Augmented"} ***!
  \***************************************************************************************************************************/
/*! no static exports found */
